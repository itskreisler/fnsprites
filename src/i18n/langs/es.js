...
export const es = {
    ...
    sync: {
        ...
        localLabel: 'Este dispositivo',
        remoteLabel: 'Google Drive',
        modifiedAt: 'Guardado',
        fileSize: 'Tamaño',
        ownedLabel: 'Coleccionados',
        masteredLabel: 'Maestrados',
        lostLabel: 'Perdidos',
        mergeResult: 'Al fusionar quedaría:',
        mergeResultCounts: '{owned} coleccionados · {mastered} maestrados · {lost} perdidos',
